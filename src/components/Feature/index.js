...
const Feature = ({ title, disc, icon }) => {
  return (
    <div className="h-fit w-fit px-4 md:w-1/2 lg:w-1/3 text-center">
      <div className="mb-4 rounded-[20px] grid justify-center p-10 btn bg-gray-300 w-fit h-fit hover:shadow-[0_4px_0px_rgba(8,_112,_184,_0.7)] text-black backdrop-blur-sm ease-out hover:translate-y-1 transition-all  md:px-7 xl:px-10">
